        ...
        <div className="user-card">
          ...
          <div className="user-info">
            ...
            <div className="details">
              {user.location && <span>ï¿½ï¿½ {user.location}</span>}
              {user.twitter_username && (
                <span>
                  &nbsp;í°¦ @{user.twitter_username}
                </span>
              )}
              {user.blog && user.blog !== "" && (
                <span>
                  &nbsp;í´— <a href={user.blog.startsWith("http") ? user.blog : `https://${user.blog}`} target="_blank" rel="noopener noreferrer">{user.blog}</a>
                </span>
              )}
            </div>
            <a
